...
http://www.xroxy.com/proxylist.php?port=&type=All_http&ssl=&country=US&latency=&reliability=#table
http://www.xroxy.com/proxylist.php?port=&type=All_http&ssl=nossl&country=US&latency=&reliability=#table
...
def fetchProxyServer(url):
  ...
  table = soup.find(id="content").find_all("table")[1]
  for tr in table.find_all("tr",class_=re.compile("row")):
